			...
			<div class="modal-content">
				...
				<form action="projetos.do" method="POST">
					<div class="modal-body">
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								<label for="input_estimativa">Estimativa </label><input id="input_estimativa" type="date"
									class="form-control" name="estimativa" required />
							</div>
							<div class="form-group col-md-3">
							...
							<div class="form-row">
								<div class="form-group col-md-4" id="departamento">
									<label for="input_departamento">Departamento</label> <input
										type="text" class="form-control" name="departamento" id="input_departamento">
								</div>
								<div class="form-group col-md-4" id="resultado_esperado">
									<label for="input_resultado_esperado">Resultado esperado</label> <input
										type="text" class="form-control" name="resultado_esperado" id="input_resultado_esperado">
								</div>
								<div class="form-group col-md-4" id="publico_beneficiario">
									<label for="input_publico_beneficiario">Público beneficiário</label> <input
										type="text" class="form-control" name="publico_beneficiario" id="input_publico_beneficiario">
								</div>
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
								...
								<textarea class="form-control" name="descricao" id="input_descricao"
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-success" name="acao" value="inserir_projeto">Cadastrar</button>
					</div>
				</form>
			</div>
		</div>
		...
		$("select#objetivo").change(
				function() {
					...
					if (objetivoSelecionado == "Melhoria de Processo") {
						...
						$('#resultado_esperado input').attr('required', 'required')
						...
						$('#publico_beneficiario input').attr('required', 'required')
					}
				});
	</script>
